exports.WAIVER_FILE = './waivers-data-updated.json'
...
exports.GITHUB_URL = `https://api.github.com/repos/GSA/made-in-america-data/contents/waivers-data-updated.json?ref=${process.env.CIRCLE_BRANCH}`
